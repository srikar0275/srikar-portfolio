...
const footerSocial = [
  ...
  { label: 'WhatsApp', href: personalInfo.social.whatsapp, Icon: WhatsAppIcon },
]
...
export default function Footer() {
  ...
  return (
    <footer className="footer">
        ...
        {footerSocial.map(({ label, href, Icon }) => (
          <li key={label}>
            <a
              ...
              aria-label={label}
              className={`footer__social-link footer__social-link--${label.toLowerCase()}`}
            >
              <Icon />
            </a>
          </li>
      ...
      <p>&copy; {year} {personalInfo.name}. Built with React.</p>
    </footer>
  )
}
